...
- <b>[Website PDF Permit Reports Creation & FTP Process]()</b>
  - <b>Used Python's Selenium to download thousands of PDF files that are then renamed & FTP'd a fileserver where the reports can be easily accessible to the public. </b>
